...
try {
    ...
    $errors[] = 'ไม่สามารถโหลดหมวดหมู่ได้';
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $projectDate = isset($_POST['project_date'])
        ? trim($_POST['project_date'])
        : '';

    $projectLocation = isset($_POST['project_location'])
...
<head>
    ...
    <title>
        เพิ่มกิจกรรม / โครงการ | PSU Photo System
    </title>
...
<main class="main">
    ...
    <div class="mb-4">
        ...
        <div class="page-subtitle">
            ...
            เพิ่มข้อมูลกิจกรรมหรือโครงการสำหรับจัดเก็บภาพถ่าย
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="help-text">
                            ...
                            ระบุชื่อกิจกรรมหรือโครงการให้ชัดเจน
                    ...
                    <div class="col-12">
                        ...
                        <input
                            ...
                            class="form-control"
                            maxlength="255"
                            placeholder="เช่น หอประชุมโรงเรียนสาธิตมหาวิทยาลัยสงขลานครินทร์"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="help-text">
                            ...
                            เจ้าหน้าที่ทั่วไปควรเริ่มจาก
                            "แบบร่าง" หรือ "รอตรวจสอบ"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="help-text">
                            ...
                            ระบบจะบันทึกผู้สร้างกิจกรรมโดยอัตโนมัติ
